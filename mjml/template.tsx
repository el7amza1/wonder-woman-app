...
export const { html, errors } = render(
  <Mjml>
    <MjmlBody background-color="#F4F4F4">
      ...
      >
        <MjmlColumn>
          ...
          >
            Thank you for applying to the [Job_title] position at
            [Company_name]. I'd like to inform you that we received your
            [application/resume/portfolio.] Our hiring team is currently
            reviewing all applications and we are planning to schedule
            interviews [mention timeframe, e.g. in the next two weeks.]
          </MjmlText>
          {/* <MjmlImage
            align="center"
