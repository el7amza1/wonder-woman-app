              ...
              <div className="col-md-12">
                ...
                <div className="form-group">
                  <div className="flex justify-center items-center w-full">
                    <label htmlFor="pdf" className=" form-control npt-l npt-l flex flex-col justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                      ...
                      <input id="pdf" type="file" className="hidden" accept=".xls,.xlsx,.xlsb,.txt,.csv,.tsv"
                        name="pdf"
                ...
                <div className="form-group">
                  <div className="flex justify-center items-center w-full">
                    <label htmlFor="coverLetter" className=" form-control npt-l npt-l flex flex-col justify-center items-center w-full h-64 bg-gray-50 rounded-lg border-2 border-gray-300 border-dashed cursor-pointer dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                      <div className="flex  justify-center items-center  ">
                        <svg aria-hidden="true" className=" w-10 h-10 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path></svg>
                      ...
                      <input id="  coverLetter" type="file" name="coverLetter"
                        className=" opacity-0" accept=".xls,.xlsx,.xlsb,.txt,.csv,.tsv"
                        onChange={(e) => setPdf(e.currentTarget.files![0])} />
                    </label>
                  </div>
